...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 24, 2026 at 09:42 PM
...
(12, '2026_09_24_110000_create_worksubmit_table', 9);
...
('2j91cDACnSsrGwHzVVK0GOfrI1ajB7nUgr1imWjd', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT; Windows NT 10.0; en-US) WindowsPowerShell/5.1.19041.6456', '', 1790268514),
...
(1, 'admin', 'admin@gmail.com', NULL, NULL, NULL, '$2y$12$.L0sJwoMg1s/BTTrcWZQ9OTrd7u2Ohu6aY2QnxoLUUEbVPC95QavG', '01915728982', 'DHK', 'https://www.facebook.com/watch/?ref=tab', '', '', '', '', 1, NULL, '2025-10-09 10:28:23', '2026-09-24 10:49:12'),
(2, 'Md. Tanvir Hossain', 'tanvir@example.com', 2, 6, NULL, '$2y$12$x6ctXcn9Im..e224WFQVLOe4vpMOYHVA.Gm74OEvZLitS4i80LExq', '01711000005', NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, '2026-09-23 13:11:56', '2026-09-23 14:25:05'),
...
--
-- Table structure for table `worksubmit`
--
...
CREATE TABLE `worksubmit` (
  ...
  `status` int(11) DEFAULT 0 COMMENT '0=pending,1=approved,2=cancel',
  `created_at` timestamp NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `worksubmit`
--

INSERT INTO `worksubmit` (`id`, `employee_id`, `project_id`, `work_date`, `hours`, `status`, `created_at`, `updated_at`) VALUES
(1, 6, 22, '2026-09-01', 5.00, 1, '2026-09-24 19:11:41', '2026-09-24 13:39:04'),
(2, 6, 22, '2026-09-02', 5.00, 1, '2026-09-24 19:11:41', '2026-09-24 13:39:04'),
(3, 6, 22, '2026-09-03', 5.00, 1, '2026-09-24 19:11:41', '2026-09-24 13:39:04'),
(4, 6, 22, '2026-09-04', 5.00, 1, '2026-09-24 19:11:41', '2026-09-24 13:39:04'),
(5, 6, 22, '2026-09-07', 5.00, 1, '2026-09-24 19:11:41', '2026-09-24 13:39:04'),
(6, 6, 22, '2026-09-08', 5.00, 1, '2026-09-24 19:11:41', '2026-09-24 13:39:04'),
(7, 6, 22, '2026-09-17', 6.00, 1, '2026-09-24 19:12:10', '2026-09-24 13:39:04'),
(8, 6, 22, '2026-09-29', 4.00, 0, '2026-09-24 19:26:52', '2026-09-24 13:39:22');
...
--
-- Indexes for table `worksubmit`
--
ALTER TABLE `worksubmit`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `worksubmit_employee_id_project_id_work_date_unique` (`employee_id`,`project_id`,`work_date`),
  ADD KEY `worksubmit_employee_id_index` (`employee_id`),
  ADD KEY `worksubmit_project_id_index` (`project_id`),
  ADD KEY `worksubmit_work_date_index` (`work_date`),
  ADD KEY `worksubmit_employee_id_work_date_index` (`employee_id`,`work_date`);
...
--
-- AUTO_INCREMENT for table `worksubmit`
--
ALTER TABLE `worksubmit`
...
--
-- Constraints for table `worksubmit`
--
ALTER TABLE `worksubmit`
  ADD CONSTRAINT `worksubmit_employee_id_foreign` FOREIGN KEY (`employee_id`) REFERENCES `employee` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `worksubmit_project_id_foreign` FOREIGN KEY (`project_id`) REFERENCES `project` (`id`) ON DELETE CASCADE;
COMMIT;
