...
export default function TrainingPageClient({ slug }) {
  ...
  const fetchPopular = async () => {
    try {
      const res = await fetch(
        `${process.env.NEXT_PUBLIC_API_BASE}/public/getsAllTraining`,
        { cache: "no-store" }
      );
      const result = await res.json();
              ...
              <div className="col-lg-8 col-md-12">
                <div className="blog-details-desc">
                  <div className="article-image">
                    <img
                      src={data.image || "/frontend_theme/blog/default-training.png"}
                      alt={data.name}
                    />
                  </div>
              ...
              <div className="col-lg-4 col-md-12">
                <aside className="widget-area extra-padding">
                  ...
                  <div className="widget widget_noke_posts_thumb">
                    <h3 className="widget-title">Popular Training</h3>
                    ...
                    {filteredPosts.map((post) => (
                      ...
                      >
                        <Link href={`/training/${post.slug}`} className="thumb">
                          <img
                            src={
                              post.thumnail_img ||
                              "/frontend_theme/blog/default-training.png"
                            }
                            alt={post.name}
                            style={{
                              width: "80px",
